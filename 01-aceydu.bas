...
20 REM *** ADLAI STEYENSON HIGH SCHOOL, PRAIRE VIEW, ILL
...
110 PRINT
160 N=100:Q=100
190 PRINT "YOU NOW HAVE":PRINT Q:PRINT "DOLLARS TO BET. "
195 PRINT
200 GOTO 260
210 Q=Q+M
220 GOTO 190
...
270 LET A=INT(RND(1)*14)
280 IF A<2 THEN 270
290 IF A>14 THEN 270
300 LET B=INT(RND(1)*14)
310 IF B<2 THEN 300
...
700 PRINT "YOU HAVE ONLY": PRINT Q: PRINT "DOLLARS TO BET."
710 GOTO 650
730 C=INT(RND(1)*20)+2
740 IF C<2 THEN 730
...
1040 PRINT: PRINT "0. K. HOPE YOU HAD FUN!!"
1050 END
